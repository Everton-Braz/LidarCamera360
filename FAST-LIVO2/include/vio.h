...
public:
  ...
  FramePtr new_frame_;
  cv::Mat img_cp, img_rgb, img_test, img_full;
  cv::Mat undist_map1, undist_map2;
  bool has_undist_map = false;
  int colmap_width = 768, colmap_height = 1024;
  double colmap_fx = 457.633379, colmap_fy = 457.828465, colmap_cx = 384.0, colmap_cy = 512.0;
